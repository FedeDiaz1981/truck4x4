...
export default function ProductModal({ product, onClose }: ProductModalProps) {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-3xl rounded-3xl border border-white/20 bg-white/90 p-8 shadow-soft backdrop-blur"
      ...
      >
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-full border border-black/10 bg-white/80 px-4 py-2 text-xs text-muted shadow-sm"
          >
            Cerrar
          </button>
        </div>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-[1.1fr_1fr]">
          ...
          <div className="grid gap-4">
            <div className="rounded-2xl border border-white/60 bg-white/80 px-4 py-4 shadow-sm">
            ...
            <div className="grid gap-3 rounded-2xl border border-white/60 bg-white/80 px-4 py-4 shadow-sm">
              <div>
